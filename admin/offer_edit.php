    ...
    <div id="content">
        ...
        <div class="container">
            <div class="form-container">
                <h2 class="form-title">Edit Offer Details</h2>
                <form id="carouselForm" method="POST" enctype="multipart/form-data" action="offer_update.php?id=<?php echo $row['id']; ?>" style="padding: 30px;">
                <div class="form-group">
                    <label for="title">Text:</label>
                    <input type="text" class="form-control" name="text" value="<?php echo $row['text']; ?>" required>
                </div>
