...
if (isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
    ...
    $sql = "INSERT INTO `top_rated` (`name`, `price`, `image`) 
    ...
    if ($query) {
        ...
        echo json_encode([
            'message' => 'Top Rated created successfully',
            'status' => 'success'
        ]);
    } else {
        // Return error message as JSON
        echo json_encode([
            'message' => 'Failed to create top rated: ' . mysqli_error($conn),
            'status' => 'error'
        ]);
    }
    exit();
...
<!-- End of Topbar -->
    <div class="container">
        <div class="form-container">
            <h2 class="form-title">Top Rated Details</h2>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    swal({
                        ...
                        window.location.href = 'top_rated_table.php';
                    });
                },
