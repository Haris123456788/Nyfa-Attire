...
if (isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
    ...
    $sql = "INSERT INTO `collection` (`name`, `category`, `price`, `rating`, `label`, `image`) 
    VALUES ('$name', '$category', '$price', '$rating', '$label', '$imageName')";  // Insert only the file name
...
<!-- End of Topbar -->
    <div class="container">
        <div class="form-container">
            <h2 class="form-title">Collection Details</h2>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    swal({
                        ...
                        window.location.href = 'collection_table.php';
                    });
                },
