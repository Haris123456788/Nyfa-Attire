    ...
    <div id="content">
        ...
        <div class="container">
            <div class="form-container">
                <h2 class="form-title">Edit Collection Details</h2>
                <form id="carouselForm" method="POST" enctype="multipart/form-data" action="collection_update.php?id=<?php echo $row['id']; ?>" style="padding: 30px;">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="category" required>
                            ...
                            <option value="best" <?php if ($row['category'] == 'best') echo 'selected'; ?>>best</option>
                            <option value="feat" <?php if ($row['category'] == 'feat') echo 'selected'; ?>>feat</option>
                            <option value="new" <?php if ($row['category'] == 'new') echo 'selected'; ?>>new</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="name_long">Rating:</label>
                        <input type="text" class="form-control" name="rating" value="<?php echo $row['rating']; ?>" placeholder="Enter rating" required>
                    </div>

                    <div class="form-group">
                        <label for="name_long">Label:</label>
                        <input type="text" class="form-control" name="label" value="<?php echo $row['label']; ?>" placeholder="Enter label" required>
                    </div>
