    ...
    <div id="content">
        ...
        <div class="container">
            <div class="form-container">
                <h2 class="form-title">Edit About Details</h2>
                <form id="carouselForm" method="POST" enctype="multipart/form-data" action="about_update.php?id=<?php echo $row['id']; ?>" style="padding: 30px;">
