    ...
    <div id="content">
        ...
        <div class="container">
            <div class="form-container">
                <h2 class="form-title">Edit Slider Details</h2>
                <form id="carouselForm" method="POST" enctype="multipart/form-data" action="slider_update.php?id=<?php echo $row['id']; ?>" style="padding: 30px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="subtitle" value="<?php echo $row['subtitle']; ?>" placeholder="Enter sub title" required>
                    </div>

                    <div class="form-group">
                        <label for="name_long">Button Text:</label>
                        <input type="text" class="form-control" name="button_text" value="<?php echo $row['button_text']; ?>" placeholder="Enter button text" required>
                    </div>
